...
package src.cn.sharesdk.onekeyshare;
	...
	public void show(Context context) {
		...
		try {
			if(OnekeyShareTheme.SKYBLUE == theme){
				...
				platformListFakeActivity = (PlatformListFakeActivity) Class.forName("cn.sharesdk.onekeyshare.theme.PlatformListFakeActivity").newInstance();
			}
		} catch (Exception e) {
			e.printStackTrace();
			return;
